...
from https://github.com/Sarcasm/run-clang-format/tree/master
With a crude swap of clang -> cmake
"""
...
def run_cmake_format_diff(args, file):
    ...
    # - cmake-format will returns the bytes read from the files as-is,
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="run N cmake-format jobs in parallel" " (default number of cpus + 1)",
    )
    parser.add_argument(
        "--color",
        default="auto",
