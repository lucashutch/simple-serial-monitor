...
class TestParseAndConvertTime:
    ...
    def test_invalid_input_string(self):
        ...
        with pytest.raises(
            ValueError, match="Input 'invalid' is neither a valid Unix timestamp"
        ):
    ...
    def test_empty_string(self):
        ...
        with pytest.raises(
            ValueError, match="Input '' is neither a valid Unix timestamp"
        ):
    ...
    def test_malformed_iso8601_string(self):
        ...
        with pytest.raises(
            ValueError, match="Input 'not-a-date' is neither a valid Unix timestamp"
        ):
